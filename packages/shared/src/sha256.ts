/**
 * Minimal synchronous SHA-256 (UTF-8 → hex) for Node and browsers.
 * Avoids `node:crypto` so Vite can bundle `@tron-payments/shared`.
 */
...
function sha256(message: Uint8Array): Uint8Array {
  ...
  // high 32 bits of length stay 0 for messages < 2^32 bits (our payloads are small)
